...
const AddFriend = () => {
  return (
    <div className="bg-[#F8FAFC] pb-10">
      ...
      <div className="w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mt-5">
        <div className="rounded-sm py-10 card bg-[#FFFFFF] card-md shadow-sm">
          <div className="card-body text-center">
            <h4 className="text-[#244D3F] text-3xl font-semibold mb-3">10</h4>
        ...
        <div className="rounded-sm py-10 card bg-[#FFFFFF] card-md shadow-sm">
          <div className="card-body text-center">
            <h4 className="text-[#244D3F] text-3xl font-semibold mb-3">12</h4>
